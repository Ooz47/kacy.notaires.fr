...
$message_txt = " Cher visiteur, vous trouverez ci-jointe la carte de visite de l�Office notarial SAS Tamara CHERGUI-VILO. 
En l'ouvrant, vous pourrez facilement ajouter nos coordonn�es � votre carnet d'adresses. 
N'h�sitez pas � nous consulter. 

.";
$message_html = "<html><head></head><body>
 Cher visiteur, vous trouverez ci-jointe la carte de visite de l�Office notarial SAS Tamara CHERGUI-VILO.<br/>
En l'ouvrant, vous pourrez facilement ajouter nos coordonn�es � votre carnet d'adresses. <br/>
N'h�sitez pas � nous consulter.<br/><br/>
</body></html>
";
//==========
...
//=====D�finition du sujet.
$sujet = "Carte de visite SAS Tamara CHERGUI-VILO";
//=========
